...
START TRANSACTION;
USE `runlog`;
INSERT INTO `run_log` (`id`, `description`, `type`, `distance_in_miles`, `time_in_minutes`, `date`) VALUES (1, 'fartlek', 'fartlek', 10, 10, NULL);
INSERT INTO `run_log` (`id`, `description`, `type`, `distance_in_miles`, `time_in_minutes`, `date`) VALUES (2, 'distance', 'distance', 20, 90, NULL);
